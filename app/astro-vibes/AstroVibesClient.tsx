            ...
            {!user ? (
              <div className="py-6 flex flex-col items-center justify-center">
                <button
                  ...
                  className="relative flex items-center gap-2 px-6 py-2.5 text-xs sm:text-sm font-fredoka font-extrabold rounded-full bg-gradient-to-r from-deep-violet to-[#4f3583] hover:from-primary-gold hover:to-[#dfa72b] text-white hover:text-deep-violet border border-primary-gold/30 hover:scale-105 active:scale-95 shadow-md hover:shadow-primary-gold/25 transition-all duration-300 cursor-pointer"
                >
                  {/* Google SVG Icon */}
