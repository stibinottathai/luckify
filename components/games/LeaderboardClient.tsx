...
export default function LeaderboardClient() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto">
      ...
      >
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary-gold/15 border border-primary-gold/30 mb-4">
          <span className="text-sm">🏆</span>
          <span className="text-xs font-extrabold uppercase tracking-widest text-primary-gold">
            Live Leaderboard
          </span>
        </div>
        ...
        {currentUserRank > 0 && (
          <motion.div
            ...
            className="inline-flex items-center gap-2 mt-3 px-4 py-1.5 rounded-full bg-accent-teal/15 border border-accent-teal/35"
          >
            <span className="text-xs font-extrabold text-accent-teal">
