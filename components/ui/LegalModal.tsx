                ...
                {activeTab === "terms" && (
                  ...
                  >
                    <div className="bg-primary-gold/5 dark:bg-primary-gold/3 p-4 border border-primary-gold/20 rounded-2xl mb-4">
                      ...
                      Please review these playful guidelines. By accessing Luck ഉണ്ടോ ?, you align your karma and agree to ride these digital frequencies with joy.
                    </div>
                    ...
                    <p>
                      To keep the site running and free for everyone, Luck ഉണ്ടോ ? will soon be introducing third-party advertisements (applying for monetization). By accessing the website, you agree to the display of advertisements.
                    </p>
